    ...
    def test_not_eq_type(self):
        ...
        class TestTextNode(unittest.TestCase):
            ...
            def test_text_node_to_html_node_image(self):
                ...
                html_node = node.text_node_to_html_node()
                self.assertEqual(html_node, LeafNode("img", None, None, {"src": "http://example.com/image.png", "alt": "This is a text node"}))

            def test_text_node_to_html_node_link(self):
                node = TextNode("This is a text node", TextType.LINK, url="http://example.com")
                html_node = node.text_node_to_html_node()
                self.assertEqual(html_node, LeafNode("a", "This is a text node", None, {"href": "http://example.com"}))

            def test_text_node_to_html_node_code(self):
                node = TextNode("This is a text node", TextType.CODE)
                html_node = node.text_node_to_html_node()
                self.assertEqual(html_node, LeafNode("code", "This is a text node", None, None))
