...
def text_to_textnodes(text):
    ...
    nodes_list = nodes_list[0].split_nodes_delimiter(nodes_list, "**", TextType.BOLD_TEXT)
    nodes_list = nodes_list[0].split_nodes_delimiter(nodes_list, "*", TextType.ITALIC_TEXT)
    nodes_list = nodes_list[0].split_nodes_delimiter(nodes_list, "`", TextType.CODE)
